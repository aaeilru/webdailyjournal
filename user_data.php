                        ...
                        <tr>
                            ...
                            <td><?= $row["password"] ?></td>
                                <td>
                                    ...
                                    ?>
                                        <img src="asset/<?= $row["foto"] ?>" width="200">
                                    <?php
                                        } else {
                            ...
                            <td>
                                <a href="#" title="edit" class="badge rounded-pill text-bg-success p-3" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $row["id"] ?>"><i class="bi bi-pencil"></i></a>
                                <a href="#" title="delete" class="badge rounded-pill text-bg-danger p-3" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $row["id"] ?>"><i class="bi bi-x-circle"></i></a>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        if ($row["foto"] != '') {
                                                            if (file_exists('asset/' . $row["foto"] . '')) {
                                                        ?>
                                                                <br><img src="asset/<?= $row["foto"] ?>" width="100">
                                                        <?php
                                                            }
                                                        }
                                                        ?>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="post" action="" enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="formGroupExampleInput" class="form-label">Yakin akan menghapus foto? "<strong><?= $row["username"] ?></strong>"?</label>
                                                        <input type="hidden" name="id" value="<?= $row["id"] ?>">
